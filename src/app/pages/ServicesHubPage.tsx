...
export default function ServicesHubPage() {
  ...
  return (
    <>
      <PageSeo
        path={path}
        title="Holistic Services in Bengaluru | S H Health Centre"
        description="Explore acupuncture, acupressure, Siddha-informed consultations, and pain support at our Kalyan Nagar clinic. Detailed service pages for Bengaluru searches."
      />
          ...
          <div className="mt-8 grid gap-10 lg:grid-cols-2 lg:items-center lg:gap-14">
            ...
            <div className="relative overflow-hidden rounded-3xl shadow-xl ring-1 ring-gray-200/80">
              <div className="aspect-[4/3] sm:aspect-[16/10]">
                <ImageWithFallback
                  src="/assets/hero.png"
                  alt="Welcoming holistic treatment environment at S H Health Centre, Bengaluru"
                ...
                <li key={s.path}>
                  ...
                  >
                    ...
                    <div className="flex min-w-0 flex-1 items-center justify-between gap-3">
                      ...
                      <ArrowRight className="h-5 w-5 shrink-0 text-[#7AA98C] transition group-hover:translate-x-0.5" />
                    </div>
                  </Link>
                </li>
              );
